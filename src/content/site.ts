...
export const story: string[] = [
  ...
  "I saw the physicists who gave their lives to defining electricity, and the engineers who shaped it so a student could make a light turn on. Then I started seeing it everywhere: the plaster walls, the heat coming from my vent, the bed where I sat. Someone's effort poured into every object in my room, made for a person they would never meet. I sent pictures of that LED to my friends. It was a tiny thing, but it was mine, and all I wanted to do was share it. That's when I felt the pull to be on the other side of that exchange.",
  "My fascination with people led me to study kinesiology: how we move, think, and interact with the world. Then a professor introduced me to brain-computer interfaces, and one idea inspired me. Technology could integrate with a body so seamlessly that it stopped feeling like a tool and started feeling like part of you. I spent the next three years researching that idea, and five peer-reviewed publications came out of it.",
  "But I felt that a lot of research never reached the hands of the people who needed it, and I wanted what I felt with that LED: to make something and share it. So I learned to build. The most recent is Wellspring, a donation app a women's center now uses every day. I am now the one who reaches people through technology.",
];
