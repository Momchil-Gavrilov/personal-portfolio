...
export const story: string[] = [
  ...
  "That feeling had names, it turned out. Ownership. Agency. Belonging. I followed it into research: kinesiology at McMaster to understand people from every angle, then three years at UC Davis studying the relationships people form with technology. Whether a prosthetic hand can feel like part of your own body. Whether controlling a robot changes your sense of authorship over your own movements. What makes a clinician trust a tool. Five peer-reviewed publications came out of it, and the question underneath all of them is the one I first felt that night: what makes a made thing feel like it belongs to you.",
  "Along the way I found that most research stays on a shelf and never reaches real people, and I wanted to satisfy that same need to share. So I learned to build and ship. The most recent is Wellspring, a donation app a women's center uses every day. Knowing that something I made is quietly part of people's lives gives me the same feeling that LED did, except now I am on the giving side of it.",
  "I believe a life is fuller when you share the best of it. What I want from my work is the chance to build technology that reaches people and changes their lives.",
];
