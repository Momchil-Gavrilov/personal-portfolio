...
/*
  ...
  ask them: what is this person for and are they real (Hero, which now carries
  the four figures beside the portrait), what can they do (Skills), what have
  they actually found (Research), is it published (Publications), can they
  ship (Projects), do I want to work with them (Story), how do I reach them
  (Contact).
